...
assert str(source_root) != "PUT_YOUR_DIRECTORY_HERE/AevaScenes", (
    "Directory to AevaScenes Perception dataset. Change to directory in your file system!"
)
...
sensor_frequencies = {
    "front_narrow_lidar": 10,
    "front_wide_lidar": 10,
    "left_lidar": 10,
    "rear_narrow_lidar": 10,
    "rear_wide_lidar": 10,
    "right_lidar": 10,
}  # Hz.
