...
# Paths.
results_root = Path("PUT_YOUR_DIRECTORY_HERE/PseudoLabeler__ablation_study1__post")
omnilidar_root = Path("PUT_YOUR_DIRECTORY_HERE/OmniLiDAR")

assert str(results_root) != "PUT_YOUR_DIRECTORY_HERE/PseudoLabeler__ablation_study1__post", (
